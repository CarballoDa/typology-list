...
* param {b} bool
*/
function ableOrDisableListTools(a: boolean, b: boolean): void
{
    ...
    (document.getElementById("removeListTitle") as HTMLButtonElement).disabled = b;
    (document.getElementById("downloadList") as HTMLButtonElement).disabled = b;
    (document.getElementById("sendList") as HTMLButtonElement).disabled = b;
    (document.getElementById("exportList") as HTMLButtonElement).disabled = b;
